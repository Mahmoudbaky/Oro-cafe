import LogoStyle from "./Socialicons.module.css";
...
function SocialMediaIcons() {
  return (
    <>
      <div className={LogoStyle.menuStyle}>
        <ul>
          <li>
            <a href="#">
              <FaFacebook className={LogoStyle.iconStyle} />
            </a>
          </li>
          <li>
            <a href="#">
              <FaXTwitter className={LogoStyle.iconStyle} />
            </a>
          </li>
          <li>
            <a href="#">
              <FaInstagram className={LogoStyle.iconStyle} />
            </a>
          </li>
          <li>
            <a href="#">
              <FaSnapchatGhost className={LogoStyle.iconStyle} />
            </a>
          </li>
          <li>
            <a href="https://maps.app.goo.gl/vg4T8V8hQMrQSZWh8">
              <SiGooglemaps className={LogoStyle.iconStyle} />
            </a>
          </li>
        </ul>
      </div>
